        ...
        <div className='about-body'>
            ...
            <div className='About-container'>
                <div className='about-para'>
                    ...
                    <Link className='Aboutbtn' to="/Projects"><button> Projects</button></Link>
                    </div>
                </div>
                <div className='clg-img'>
                    ...
                    <img className='about-img' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTAE5HnisbVhrEGl5qhVRnQa3gAH4fDf27xg&s" alt="img2" />
                </div>
            </div>
        </div>
    )
